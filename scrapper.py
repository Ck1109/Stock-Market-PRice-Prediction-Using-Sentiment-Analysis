...
def getNews(company, writeCloud=False, proxies=''):
    ...
    keys = ['e44d164dd2bf4008a9a6097004834c00']
        ...
        for article in news['articles']:
            if article['title'] not in titles and company.lower() in article['title'].lower():
                ...
                article['content'] = getFullArticleContent(company=company, url=article['url'],
                                                           pre_content=article['content'], proxies=proxies)
...
def getAllNews():
    companies = ['Adani Power', 'Tata Steel', 'Wipro', 'TCS', 'Infosys', 'Cipla', 'HDFC', 'Bharti Airtel', 'Bajaj Finance', 'ITC']
    urls = []
